...
CUDA_VISIBLE_DEVICES=3 python src/run.py -c agem -d cub --experiments_dir cub-experiments --config.hp.num_mem_samples_per_class 3 &
...
CUDA_VISIBLE_DEVICES=1 python src/run.py -c dem -d tiny_imagenet --experiments_dir tiny_imagenet-experiments --config.hp.memory.num_samples_per_class 2 --config.hp.memory.downsample_size 32 --config.hp.lowres_training.logits_matching_loss_coef 1 2> logs/tiny_imagenet-dem-32-2.log &
...
# Simple baselines
CUDA_VISIBLE_DEVICES=2 python src/run.py -c basic -d tiny_imagenet --experiments_dir tiny_imagenet-experiments 2> logs/tiny_imagenet-basic.log .log &
CUDA_VISIBLE_DEVICES=3 python src/run.py -c joint -d tiny_imagenet --experiments_dir tiny_imagenet-experiments 2> logs/tiny_imagenet-joint.log .log &
...
CUDA_VISIBLE_DEVICES=4 python src/run.py -c dem -d tiny_imagenet --experiments_dir tiny_imagenet-experiments --config.hp.memory.num_samples_per_class 2 --config.hp.memory.downsample_size 64 2> logs/tiny_imagenet-dem-64-2.log &
CUDA_VISIBLE_DEVICES=4 python src/run.py -c dem -d tiny_imagenet --experiments_dir tiny_imagenet-experiments --config.hp.memory.num_samples_per_class 4 --config.hp.memory.downsample_size 64 2> logs/tiny_imagenet-dem-64-4.log &
...
CUDA_VISIBLE_DEVICES=6 python src/run.py -c icarl -d tiny_imagenet --experiments_dir tiny_imagenet-experiments --config.hp.memory.max_size 600 2> logs/tiny_imagenet-icarl-600.log &
...
CUDA_VISIBLE_DEVICES=8 python src/run.py -c agem -d tiny_imagenet --experiments_dir tiny_imagenet-experiments --config.hp.num_mem_samples_per_class 3 2> logs/tiny_imagenet-agem-3.log &
...
CUDA_VISIBLE_DEVICES=0 python src/run.py -c dem -d awa --experiments_dir awa-experiments --config.hp.memory.num_samples_per_class 3 --config.hp.memory.downsample_size 256 2> logs/awa_dem_256_3.log &
...
CUDA_VISIBLE_DEVICES=6 python src/run.py -c icarl -d awa --experiments_dir awa-experiments --config.hp.memory.max_size 600 2> logs/awa_icarl_600.log &
...
CUDA_VISIBLE_DEVICES=7 python src/run.py -c agem -d awa --experiments_dir awa-experiments --config.hp.num_mem_samples_per_class 2 2> logs/awa_agem_2.log &
...
CUDA_VISIBLE_DEVICES=4 python src/run.py -c dem -d cub --experiments_dir cub-experiments --config.hp.memory.num_samples_per_class 8 --config.hp.memory.downsample_size 128 --config.hp.lowres_training.logits_matching_loss_coef 0
CUDA_VISIBLE_DEVICES=5 python src/run.py -c dem -d cub --experiments_dir cub-experiments --config.hp.memory.num_samples_per_class 8 --config.hp.memory.downsample_size 128 --config.hp.lowres_training.logits_matching_loss_coef 1

CUDA_VISIBLE_DEVICES=7 python src/run.py -c dem -d cub --experiments_dir cub-experiments --config.hp.memory.num_samples_per_class 4 --config.hp.memory.downsample_size 128 --config.hp.lowres_training.logits_matching_loss_coef 0
CUDA_VISIBLE_DEVICES=8 python src/run.py -c dem -d cub --experiments_dir cub-experiments --config.hp.memory.num_samples_per_class 4 --config.hp.memory.downsample_size 128 --config.hp.lowres_training.logits_matching_loss_coef 1